...
shellyHelperGen2.addDevicePowerToGen2Device(shellyhtg3, 0, true);

shellyHelperGen2.addTemperatureSensorToGen2Device(shellyhtg3, 0);

shellyHelperGen2.addHumiditySensorToGen2Device(shellyhtg3, 0);
